...
This report explores the spatial and temporal variation in global water insecurity levels utilizing the water_insecurity_2022 and water_insecurity_2023 data sets.

The spatial distribution of global water insecurity was mapped using the dplyr and purrr packages for 2022 and 2023 separately. In this way, it can see if there are differences in indoor plumbing availability between western and eastern counties in the United States. (@fig-1 @fig-2)
